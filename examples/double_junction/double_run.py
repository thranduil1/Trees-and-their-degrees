...
from mathmodels.double_junction.degree.degree_computations import (
    tree_detector_boundary_degree,
)
from mathmodels.double_junction.degree.regular_values import (
    pick_deep_interior_point,
    sample_outputs,
)
