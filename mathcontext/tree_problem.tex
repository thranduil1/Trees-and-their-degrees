...
\end{center} 
Each $a$-junction has degree $a-1$ and each $b$-junction has degree $b-1$ again, 
but what happens when the junctions are switching?
We add an $ab$-junction which represents the switch:
\begin{center}
...
Now we've added an extra junction, and we would like to determine its degree. 
